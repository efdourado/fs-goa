 ...
 * the layout re-renders with the new catalog (the client tree is remounted with
 * fresh messages).
 */
    ...
    >
      {locales.map((value) => (
        <button
          ...
          className={cx(
            "min-h-7 cursor-pointer rounded-full px-2.5 text-xs font-semibold uppercase transition disabled:cursor-progress",
            active === value
